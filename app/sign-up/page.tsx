        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-2">
              <Checkbox id="terms" className="border-gray-600 data-[state=checked]:bg-teal-500 mt-1" required />
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                variant="outline"
                className="border-gray-800 bg-black/30 hover:bg-black/50 hover:text-white hover:animate-bounce transition-all duration-300"
              >
